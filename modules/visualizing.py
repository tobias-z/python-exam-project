...
def show_prices(cereals, per_100g=False):
    ...
    for store in stores:
        ...
        cereals_prices = {
            cereal.get_brand_name(): __get_price(value, cereal.grams, per_100g)
...
def show_pct_of_recommended_nutrition(cereal, sex):
    ...
    title = (
        "Percentage of %s %s's Nutrional Content compared to Daily Recommended Intake"
        % (cereal.brand.capitalize(), cereal.name.capitalize())
    )
